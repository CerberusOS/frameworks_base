...
public class PhoneWindowManager implements WindowManagerPolicy {
 ...
 // Power long press action saved on key down that should happen on key up
    ...
    private boolean mTorchLongPressPowerEnabled = true;
            ...
            if (interactive) {
                ...
                if (hasLongPressOnPowerBehavior()) {
                    if ((event.getFlags() & KeyEvent.FLAG_LONG_PRESS) != 0) {
                        Slog.i(TAG, "powerLongPress(1)");
                        powerLongPress();
                    } else {
                        Slog.i(TAG, "powerLongPress(2)");
                ...
                Slog.i(TAG, "powerLongPress mS=" + mSupportLongPressPowerWhenNonInteractive + ", hL=" + hasLongPressOnPowerBehavior());
                if (mSupportLongPressPowerWhenNonInteractive && hasLongPressOnPowerBehavior()) {
                    if ((event.getFlags() & KeyEvent.FLAG_LONG_PRESS) != 0) {
                        Slog.i(TAG, "powerLongPress(3)");
                        powerLongPress();
                    } else {
                        Slog.i(TAG, "powerLongPress(4)");
                        mResolvedLongPressOnPowerBehavior = getResolvedLongPressOnPowerBehavior();
    ...
    private void cancelPendingPowerKeyAction() {
        if (!mPowerKeyHandled) {
            ...
            if (mResolvedLongPressOnPowerBehavior == LONG_PRESS_POWER_TORCH && mBeganFromNonInteractive /*!isScreenOn() */) {
    ...
    private int getResolvedLongPressOnPowerBehavior() {
        ...
        Slog.i(TAG, "getResolvedLongPressOnPowerBehavior=" + mLongPressOnPowerBehavior);
    ...
    public void setInitialDisplaySize(Display display, int width, int height, int density) {
        ...
        Slog.d(TAG, "updateSettings: defaultToNavigationBar=" + defaultToNavigationBar + 
                    " mHasNavigationBar=" + mHasNavigationBar +
                    " mNavBarEnabled=" + mNavBarEnabled);
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            Slog.d(TAG, "updateSettings: navBarEnabled=" + navBarEnabled);
